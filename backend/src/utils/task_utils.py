...
def reorder_tasks_diff_phases(
        prev_phase_id, new_phase_id, task_id,
        order_prev_phase, order_new_phase):
    tasks = []
    if not (prev_phase_id and new_phase_id and task_id
            and order_prev_phase and order_new_phase):
        return tasks
